...
def get_training_set(train_dir, train_list=None, model_type='cs', svp=True):
    if train_list == None:
        ...
        img_list = train_list 
    return DatasetFromFolder(train_dir, img_list, model_type, svp)

def get_validating_set(valid_dir, valid_list=None, model_type='cs', svp=True):
    if valid_list == None:
        ...
        img_list = img_list
    return DatasetFromFolder(valid_dir, img_list, model_type, svp)


class DatasetFromFolder(Dataset):
    def __init__(self, data_dir, img_list, model_type, svp=True):
